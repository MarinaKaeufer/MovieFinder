...
import { getMe, deleteMovie, editMovie } from '../utils/API';
...
const SavedMovies = () => {
  ...
  const handleEditMovie = async (userId, movie) => {
    const token = Auth.loggedIn() ? Auth.getToken() : null;
              ...
              <Card key={movie.movieId} border='dark'>
                ...
                <Card.Body>
                  ...
                  <div>
                    ...
                    <textarea id={`note-${movie.movieId}`} defaultValue={movie.notes} rows={3}  />
                    <Button id="editButton" className='btn-block' onClick={() => handleEditMovie(userData.id, movie)}>Edit Notes</Button>
                  </div>
